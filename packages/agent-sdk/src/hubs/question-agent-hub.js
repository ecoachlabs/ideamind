...
exports.QuestionAgent = exports.QuestionAgentHub = void 0;
const base_agent_1 = require("../base-agent");
const llm_1 = require("../llm");
// ============================================================================
// QUESTION AGENT HUB
// ============================================================================
class QuestionAgentHub {
    phaseConfigs;
    constructor() {
...
exports.QuestionAgentHub = QuestionAgentHub;
// ============================================================================
...
class QuestionAgent extends base_agent_1.BaseAgent {
    ...
    constructor(config) {
        ...
        this.llm = llm_1.LLMFactory.createProvider(config.phase, 'question-agent');
    }
    /**
     ...
     */
    buildQuestionPrompt(artifactsContent) {
...
Respond ONLY with JSON. No markdown, no explanation.`;
    ...
    parseQuestions(responseText) {
        try {
            ...
            return parsed.questions.slice(0, 20).map((q, index) => ({
...
//# sourceMappingURL=question-agent-hub.js.map