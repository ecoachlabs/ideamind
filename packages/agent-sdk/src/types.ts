...
export interface AnalyzerDecision {
  ...
  toolId?: string;
  toolVersion?: string;
  voiScore?: number; // Value-of-Information: 0-1
  reasoning: string;
...
export const ToolPolicySchema = z.object({
  allowedTools: z.array(z.string()).optional(), // Tool IDs or patterns
  deniedTools: z.array(z.string()).optional(),
  maxToolInvocations: z.number().int().positive().default(10),
  maxToolCostUsd: z.number().positive().default(5.0),
  requireApproval: z.boolean().default(false),
  voiThreshold: z.number().min(0).max(1).default(0.3), // Minimum VoI to invoke tool
});
